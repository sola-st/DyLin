...
## Option 1: Replace NaN values with other values ##
df_train_1 = df_train.copy()
df_test_1 = df_test.copy()

# HomePlanet: Replace the missing values with the most frequent values
imp_1=SimpleImputer(strategy='most_frequent')
df_train_1['HomePlanet']=imp_1.fit_transform(df_train_1['HomePlanet'].values.reshape(-1,1)).flatten()
...
df_train_1['CryoSleep']=imp_2.fit_transform(df_train_1['CryoSleep'].values.reshape(-1,1)).flatten()
...
df_train_1['Cabin']=imp_1.fit_transform(df_train_1['Cabin'].values.reshape(-1,1)).flatten()
...
df_train_1['Destination']=imp_1.fit_transform(df_train_1['Destination'].values.reshape(-1,1)).flatten()
...
df_train_1['Age']=imp_2.fit_transform(df_train_1['Age'].values.reshape(-1,1)).flatten()
...
df_train_1['VIP']=imp_1.fit_transform(df_train_1['VIP'].values.reshape(-1,1)).flatten()
...
df_train_1['RoomService']=imp_2.fit_transform(df_train_1['RoomService'].values.reshape(-1,1)).flatten()
...
df_train_1['FoodCourt']=imp_2.fit_transform(df_train_1['FoodCourt'].values.reshape(-1,1)).flatten()
...
df_train_1['ShoppingMall']=imp_2.fit_transform(df_train_1['ShoppingMall'].values.reshape(-1,1)).flatten()
...
df_train_1['Spa']=imp_2.fit_transform(df_train_1['Spa'].values.reshape(-1,1)).flatten()
...
df_train_1['VRDeck']=imp_2.fit_transform(df_train_1['VRDeck'].values.reshape(-1,1)).flatten()
...
df_train_1['Name']=imp_1.fit_transform(df_train_1['Name'].values.reshape(-1,1)).flatten()
...
df_train_2.drop(['Cabin','Name'],axis=1,inplace=True)
...
df_train_2['HomePlanet']=le.fit_transform(df_train_2['HomePlanet'])

df_train_1['CryoSleep']=le.fit_transform(df_train_1['CryoSleep'])
df_test_1['CryoSleep']=le.fit_transform(df_test_1['CryoSleep'])
df_train_2['CryoSleep']=le.fit_transform(df_train_2['CryoSleep'])
...
df_train_2['Destination']=le.fit_transform(df_train_2['Destination'])

df_train_1['VIP']=le.fit_transform(df_train_1['VIP'])
df_test_1['VIP']=le.fit_transform(df_test_1['VIP'])
df_train_2['VIP']=le.fit_transform(df_train_2['VIP'])
...
y_2=df_train_2.iloc[:,-1]
x_1=df_train_1.iloc[:,:-1]
x_2=df_train_2.iloc[:,:-1]
